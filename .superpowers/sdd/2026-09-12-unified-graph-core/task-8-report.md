...
- Calling `closeExpansion` is the authoritative signal that slot preparation/consumption has completed. Before that call, even a vertex exposing zero slots remains unprepared and cannot complete.
