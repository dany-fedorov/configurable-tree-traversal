...
> {
  ...
  postOrderNotVisitedChildrenCountMap: Map<
    ...
    number
  >;
  visitorsState: VisitorsState<TTP, RW_TTP>;
...
>(
  ...
  function onPreOrder(
    ...
    resolvedTreesContainer.resolvedTree.onPreOrderVisit(
      vertexRef,
      vertexContext,
    );
    if (
      ...
      resolvedTreesContainer.notMutatedResolvedTree?.onPreOrderVisit(
        notMutatedRef,
        vertexContext === null
          ? null
          : ({
